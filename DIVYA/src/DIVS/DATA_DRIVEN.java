	...
	public WebDriver driver;
	 ...
	 @Test
		...
		for (int i =1; i <= rowcount;i++) {
			...
			//Assert.assertEquals("http://demo.guru99.com/test/newtours/login_sucess.php",driver.getCurrentUrl());
				 // Assert.assertNotEquals("http://demo.guru99.com/test/newtours/login_sucess.php",driver.close());
			    // Assert.assertTrue(driver.findElement(By.xpath("//*[text()='Login Successfully']")).isDisplayed());
			     //after assertion any command failed we use driver.close();failed brwser will closed and another command will work but here not working
			     //driver.close();
...
//			  sheet.getRow(5).createCell(2).setCellValue("pass");
			...
			//Create the result file under the result folder	  
			  FileOutputStream fos = new FileOutputStream("C:\\Users\\admin\\Desktop\\practice\\guru99tours3.xlsx");
			  workbook.write(fos);
