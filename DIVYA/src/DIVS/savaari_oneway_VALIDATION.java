...
public class savaari_oneway_VALIDATION {
	public WebDriver driver;
	  @Test
	  public void f() {
		  //printing the boolean condition where true/false
		  boolean printcondition=driver.findElement(By.xpath("//*[text()=\"One Way\"]")).isDisplayed();
		  System.out.println(printcondition);
		  
		  WebElement oneway=driver.findElement(By.xpath("//*[text()=\"One Way\"]"));
